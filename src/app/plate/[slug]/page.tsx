            ...
            <div>
              ...
              <div className="bg-[var(--background-subtle)] rounded-2xl p-6">
                ...
                <p className="text-[var(--text-secondary)] text-sm mb-4">
                  Save to favourites, get notified of similar listings, and more.
                </p>
                <Link
                  href="https://apps.apple.com/app/ausplates"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 w-full px-6 py-3 border border-[var(--border)] text-[var(--text)] text-base font-medium rounded-xl hover:bg-white transition-colors"
                >
