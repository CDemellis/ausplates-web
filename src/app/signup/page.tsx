    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[var(--text)]">Create your account</h1>
          <p className="text-[var(--text-secondary)] mt-2">Join AusPlates to buy and sell plates</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-[var(--text-muted)]">or sign up with email</span>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <p className="text-xs text-[var(--text-muted)] text-center">
            ...
            <Link href="/terms" className="text-[var(--green)] hover:underline">
              Terms of Service
            </Link>{' '}
            and{' '}
            <Link href="/privacy" className="text-[var(--green)] hover:underline">
              Privacy Policy
            </Link>
          </p>
        </form>
