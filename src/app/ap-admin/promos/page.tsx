  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
        <Link href="/promos/create" className="p-4 bg-white border border-[#EBEBEB] rounded-lg hover:border-[#00843D] transition-colors text-center">
          <div className="text-2xl mb-2">+</div>
          <div className="text-sm font-medium text-[#1A1A1A]">Create Code</div>
        </Link>
        <Link href="/promos/sources" className="p-4 bg-white border border-[#EBEBEB] rounded-lg hover:border-[#00843D] transition-colors text-center">
          <div className="text-2xl mb-2">📊</div>
          <div className="text-sm font-medium text-[#1A1A1A]">Sources</div>
        </Link>
        <Link href="/promos/welcome" className="p-4 bg-white border border-[#EBEBEB] rounded-lg hover:border-[#00843D] transition-colors text-center">
          <div className="text-2xl mb-2">👋</div>
          <div className="text-sm font-medium text-[#1A1A1A]">Welcome</div>
        </Link>
        <Link href="/promos/manual" className="p-4 bg-white border border-[#EBEBEB] rounded-lg hover:border-[#00843D] transition-colors text-center">
          <div className="text-2xl mb-2">🎫</div>
          <div className="text-sm font-medium text-[#1A1A1A]">Manual</div>
        </Link>
        <Link href="/promos/flagged" className="p-4 bg-white border border-[#EBEBEB] rounded-lg hover:border-[#00843D] transition-colors text-center relative">
          <div className="text-2xl mb-2">🚩</div>
        ...
        <Link href="/promos/manual?type=sourced" className="p-4 bg-white border border-[#EBEBEB] rounded-lg hover:border-[#00843D] transition-colors text-center">
          <div className="text-2xl mb-2">🔗</div>
